    ...
    <header id="header" class="header fixed-top">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a class="nav-link scrollto active" href="#hero">  @lang('auth.home') </a></li>
                    <li><a class="nav-link scrollto" href="#about"> @lang('auth.about') </a></li>
                    <li><a class="nav-link scrollto" href="#services">@lang('auth.service')</a></li>
                    <li><a class="nav-link scrollto" href="#portfolio">Portfolio</a></li>
                    <li><a class="nav-link scrollto" href="#team">Team</a></li>
                    <li><a class="nav-link scrollto" href="#contact">Contact</a></li>
                    <li class="dropdown"><a href="#"><span>{{ app()->getLocale() == 'bn'? 'Bengali':'English' }}</span> <i class="bi bi-chevron-down"></i></a>
                        <ul>
                            <li><a href="{{ url(app()->getLocale() == 'bn'? 'en':'bn' ) }}">{{ app()->getLocale() == 'bn'? 'English':'Bengali' }}</a></li>
                        </ul>
                    </li>
                </ul>
